...
async function createAuthorizationCode(req, res, next) {
    try {
        const { AuthorizationCode, RetailEnrolleeDependent, Provider, Diagnosis } = req.models;
        ...
        await addAuditLog(req.models, {
            action: 'retailDependentAuthorizationCode.created',
...
async function getAuthorizationCodeById(req, res, next) {
    try {
        ...
        const authorizationCode = await AuthorizationCode.findOne({
            where: { id: authorizationCodeId, retailEnrolleeDependentId: dependentId },
            include: [
                { model: Provider, attributes: ['id', 'name', 'code'] },
                { model: Diagnosis, attributes: ['id', 'name'] }
            ]
...
async function useAuthorizationCode(req, res, next) {
    try {
        ...
        // Add audit log
        await addAuditLog(req.models, {
            action: 'retailDependentAuthorizationCode.used',
...
async function updateAuthorizationCode(req, res, next) {
    try {
        ...
        // Add audit log
        await addAuditLog(req.models, {
            action: 'retailDependentAuthorizationCode.updated',
...
async function cancelAuthorizationCode(req, res, next) {
    try {
        ...
        // Add audit log
        await addAuditLog(req.models, {
            action: 'retailDependentAuthorizationCode.cancelled',
...
async function deleteAuthorizationCode(req, res, next) {
    try {
        ...
        // Add audit log
        await addAuditLog(req.models, {
            action: 'retailDependentAuthorizationCode.deleted',
