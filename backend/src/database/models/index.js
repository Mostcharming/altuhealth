...
function defineModels(sequelize) {
  ...
  const PlanBenefit = require("./planBenefit.model")(sequelize, DataTypes);
  ...
  const CurrencyRate = require("./currencyRate.model")(sequelize, DataTypes);
  ...
  const CompanyPlanBenefit = require("./companyPlanBenefit.model")(sequelize, DataTypes);
  ...
  const AuthorizationCodeRendered = require("./authorizationCodeRendered.model")(sequelize, DataTypes);
  ...
  const Integration = require("./integration.model")(sequelize, DataTypes);
  const PeriodTracker = require("./periodTracker.model")(sequelize, DataTypes);
  ...
  Benefit.belongsTo(BenefitCategory, { foreignKey: "benefitCategoryId", as: 'benefitCategory' });
  ...
  // Plan <-> Benefit many-to-many through PlanBenefit
  Plan.belongsToMany(Benefit, { through: PlanBenefit, foreignKey: 'planId', otherKey: 'benefitId', as: 'benefits' });
  Benefit.belongsToMany(Plan, { through: PlanBenefit, foreignKey: 'benefitId', otherKey: 'planId' });

  // PlanBenefit direct relationships
  PlanBenefit.belongsTo(Plan, { foreignKey: 'planId' });
  Plan.hasMany(PlanBenefit, { foreignKey: 'planId' });

  PlanBenefit.belongsTo(Benefit, { foreignKey: 'benefitId' });
  Benefit.hasMany(PlanBenefit, { foreignKey: 'benefitId' });
  ...
  // CompanyPlan <-> Benefit many-to-many through CompanyPlanBenefit
  CompanyPlan.belongsToMany(Benefit, { through: CompanyPlanBenefit, foreignKey: 'companyPlanId', otherKey: 'benefitId', as: 'benefits' });
  Benefit.belongsToMany(CompanyPlan, { through: CompanyPlanBenefit, foreignKey: 'benefitId', otherKey: 'companyPlanId' });

  // CompanyPlanBenefit direct relationships
  CompanyPlanBenefit.belongsTo(CompanyPlan, { foreignKey: 'companyPlanId' });
  CompanyPlan.hasMany(CompanyPlanBenefit, { foreignKey: 'companyPlanId' });

  CompanyPlanBenefit.belongsTo(Benefit, { foreignKey: 'benefitId' });
  Benefit.hasMany(CompanyPlanBenefit, { foreignKey: 'benefitId' });
  ...
  Enrollee.belongsTo(CompanyPlan, { foreignKey: "companyPlanId", as: 'companyPlan' });
  ...
  Invoice.belongsTo(RetailEnrollee, { foreignKey: "retailEnrolleeId" });
  ...
  // InvoiceLineItem <-> Service one-to-many
  ...
  // SearchHistory <-> Provider one-to-many
  ...
  // Pharmacy reimbursement workflow
  Enrollee.hasMany(PharmacyRequest, { foreignKey: "enrolleeId", as: 'pharmacyRequests' });
  PharmacyRequest.belongsTo(Enrollee, { foreignKey: "enrolleeId", as: 'enrollee' });

  RetailEnrollee.hasMany(PharmacyRequest, { foreignKey: "retailEnrolleeId", as: 'pharmacyRequests' });
  PharmacyRequest.belongsTo(RetailEnrollee, { foreignKey: "retailEnrolleeId", as: 'retailEnrollee' });

  PharmacyRequest.hasMany(PharmacyRequestItem, { foreignKey: "pharmacyRequestId", as: 'items' });
  PharmacyRequestItem.belongsTo(PharmacyRequest, { foreignKey: "pharmacyRequestId", as: 'request' });

  PharmacyRequest.hasOne(PharmacyPayment, { foreignKey: "pharmacyRequestId", as: 'payment' });
  PharmacyPayment.belongsTo(PharmacyRequest, { foreignKey: "pharmacyRequestId", as: 'request' });

  Admin.hasMany(PharmacyRequest, { foreignKey: "createdBy", as: 'createdPharmacyRequests', constraints: false });
  PharmacyRequest.belongsTo(Admin, { foreignKey: "createdBy", as: 'creator', constraints: false });
  Admin.hasMany(PharmacyRequest, { foreignKey: "reviewedBy", as: 'reviewedPharmacyRequests', constraints: false });
  PharmacyRequest.belongsTo(Admin, { foreignKey: "reviewedBy", as: 'reviewer', constraints: false });
