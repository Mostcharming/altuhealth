      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-1.5 text-sm leading-6 text-gray-500 dark:text-gray-400">
            Get an alert when a provider records a dependent&apos;s visit while
            requesting authorization. Enabling this also lets you view
            dependent medical history; disabling it hides that history.
          </p>
          {message && (
        ...
        <div
          className="inline-flex shrink-0 rounded-lg border border-gray-200 p-1 dark:border-gray-700"
          aria-label="Dependent visit notification preference"
        >
          <button
            type="button"
            disabled={saving}
