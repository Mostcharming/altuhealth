...
import { fetchAuditLogs } from "@/lib/apis/auditLog";
import capitalizeWords from "@/lib/capitalize";
import { formatDate } from "@/lib/formatDate";
import { AuditLog, useAuditLogStore } from "@/lib/store/auditLogStore";
...
const AuditLogTable: React.FC = () => {
  ...
  const setAuditLogs = useAuditLogStore((s) => s.setAuditLogs);
  ...
  }, [limit, currentPage, search, selectedUserType, setAuditLogs]);
            ...
            <tbody className="divide-x divide-y divide-gray-200 dark:divide-gray-800">
              {auditLogs.map((log: AuditLog) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-400 line-clamp-2">
                      {log.message || "-"}
                    </span>
                  </td>
                  <td className="p-4 whitespace-nowrap">
