...
import { fetchEnrolleeDependents } from "@/lib/apis/enrolleeDependent";
...
interface EnrolleeDependentsTableProps {
  enrolleeId: string;
}

const EnrolleeDependentsTable: React.FC<EnrolleeDependentsTableProps> = ({
  enrolleeId,
}) => {
  ...
  const fetch = useCallback(async () => {
    try {
      ...
      const data = await fetchEnrolleeDependents({
        enrolleeId,
        limit,
        page: currentPage,
      });
  ...
  }, [limit, currentPage, enrolleeId, setDependents]);
