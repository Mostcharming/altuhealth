...
import DependentAuthorizationCodesTable from "./dependentAuthorizationCodesTable";
import DependentMedicalHistoryTable from "./dependentMedicalHistoryTable";
            ...
            activeTab === tab.key && (
              <div key={tab.key}>
                ...
                {tab.key === "authorization" && (
                  <div>
                    <DependentAuthorizationCodesTable dependentId={id} />
                  </div>
                )}
              </div>
            )
