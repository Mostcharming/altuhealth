...
interface DependentAuthorizationCodesTableProps {
  dependentId: string;
}

const DependentAuthorizationCodesTable: React.FC<
  DependentAuthorizationCodesTableProps
> = ({ dependentId }) => {
  ...
  const fetch = useCallback(async () => {
    try {
      ...
      const url = `/admin/enrollee-dependents/${dependentId}/authorization-codes?${params.toString()}`;
...
export default DependentAuthorizationCodesTable;
