...
import RetailEnrolleeAuthorizationCodesTable from "./retailEnrolleeAuthorizationCodesTable";
import RetailEnrolleeBenefitsTable from "./retailEnrolleeBenefitsTable";
import RetailEnrolleeDependentsTable from "./retailEnrolleeDependentsTable";
import RetailEnrolleeMedicalHistoryTable from "./retailEnrolleeMedicalHistoryTable";
          ...
          (tab) =>
            activeTab === tab.key && (
              <div key={tab.key}>
                {tab.key === "benefit" && (
                  <div>
                    <RetailEnrolleeBenefitsTable retailEnrolleeId={id} />
                  </div>
                )}
                {tab.key === "medical" && (
                  <div>
                    <RetailEnrolleeMedicalHistoryTable retailEnrolleeId={id} />
                  </div>
                )}
                {tab.key === "authorization" && (
                  <div>
                    <RetailEnrolleeAuthorizationCodesTable
                      retailEnrolleeId={id}
                    />
                  </div>
                )}
                {tab.key === "dependents" && (
                  <div>
                    <RetailEnrolleeDependentsTable retailEnrolleeId={id} />
                  </div>
                )}
              </div>
            )
