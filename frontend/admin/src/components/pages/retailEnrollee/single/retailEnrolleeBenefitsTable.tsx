// filepath: /Users/mac/Documents/dev/altuhealth/frontend/admin/src/components/pages/retailEnrollee/single/retailEnrolleeBenefitsTable.tsx
"use client";
...
interface RetailEnrolleeBenefitsTableProps {
  retailEnrolleeId: string;
}

const RetailEnrolleeBenefitsTable: React.FC<
  RetailEnrolleeBenefitsTableProps
> = ({ retailEnrolleeId }) => {
...
export default RetailEnrolleeBenefitsTable;
