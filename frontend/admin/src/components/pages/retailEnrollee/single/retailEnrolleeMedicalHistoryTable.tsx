...
interface RetailEnrolleeMedicalHistoryTableProps {
...
const RetailEnrolleeMedicalHistoryTable: React.FC<
  RetailEnrolleeMedicalHistoryTableProps
> = ({ retailEnrolleeId }) => {
  ...
  const fetch = useCallback(async () => {
    try {
      ...
      const url = `/admin/retail-enrollees/${retailEnrolleeId}/medical-histories?${params.toString()}`;
  ...
  }, [limit, currentPage, selectedStatus, retailEnrolleeId]);
...
export default RetailEnrolleeMedicalHistoryTable;
