...
const RetailDependentsTable: React.FC = () => {
  ...
  const [selectedRetailEnrolleeId, setSelectedRetailEnrolleeId] =
    useState<string>("");
  const [retailEnrollees, setRetailEnrollees] = useState<RetailEnrollee[]>([]);
  ...
  type Header = {
    key: keyof RetailEnrolleeDependent | "actions";
    label: string;
  };
  ...
  // Fetch retail enrollees on mount
  useEffect(() => {
  ...
  const fetch = useCallback(async () => {
    try {
      ...
      const items: RetailEnrolleeDependent[] =
  ...
  }, [limit, currentPage, search, selectedRetailEnrolleeId, setDependents]);
          ...
          <div className="hidden flex-col gap-3 sm:flex sm:flex-row sm:items-center">
            <div>
              <Select
                ...
                defaultValue={selectedRetailEnrolleeId}
              />
            </div>
        ...
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full table-auto">
            ...
            <tbody className="divide-x divide-y divide-gray-200 dark:divide-gray-800">
              {dependents.map((dependent: RetailEnrolleeDependent) => (
                <tr
                  key={dependent.id}
...
export default RetailDependentsTable;
