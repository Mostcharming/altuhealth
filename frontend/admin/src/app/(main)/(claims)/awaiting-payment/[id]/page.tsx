...
import PaymentActionModal from "@/components/pages/awaiting-payment-claim/paymentActionModal";
...
export default function AwaitingPaymentClaimDetail() {
  ...
  useEffect(() => {
    document.title = "AltuHealth Admin Awaiting Payment Claim Details";
  }, []);
  ...
  const pageTitle = claim
    ...
    : "Awaiting Payment Claim Details";
  ...
  return (
    <div>
      {loading ? (
        ...
        <>
          <PageBreadcrumbSub
            parentTitle="Awaiting Payment"
            parentHref="/awaiting-payment"
