...
import VetClaimActionModal from "@/components/pages/vet-claim/vetClaimActionModal";
...
export default function VetClaimDetail() {
  ...
  useEffect(() => {
    document.title = "AltuHealth Admin Vet Claim Details";
  }, []);
