...
const ClaimTable: React.FC = () => {
  ...
  const fetch = useCallback(async () => {
    try {
      ...
      const data = await fetchClaims({
        ...
        status:
          selectedStatus ||
          "submitted,pending_vetting,under_review,awaiting_payment,paid,rejected,partially_paid,queried",
      });
  ...
  }, [limit, currentPage, search, selectedStatus, setClaims]);
  ...
  const handleNavigate = (claim: Claim) => {
    router.push(`/submitted-bills/${claim.id}`);
  };
