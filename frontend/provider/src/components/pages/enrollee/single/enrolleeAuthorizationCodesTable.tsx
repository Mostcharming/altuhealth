...
interface EnrolleeAuthorizationCodesTableProps {
  enrolleeId: string;
}

const EnrolleeAuthorizationCodesTable: React.FC<
  EnrolleeAuthorizationCodesTableProps
> = ({ enrolleeId }) => {
  ...
  }, [limit, currentPage, search, enrolleeId, setAuthorizationCodes]);
...
export default EnrolleeAuthorizationCodesTable;
