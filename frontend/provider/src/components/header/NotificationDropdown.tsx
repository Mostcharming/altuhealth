...
export default function NotificationDropdown() {
  ...
  const handleNotificationClick = async (n: Notification) => {
    ...
    try {
      await apiClient("/api/providers/notifications/read", {
        method: "PUT",
        body: { id: n.id },
      });
    } catch (err) {
  ...
  const fetchNotifications = useCallback(async () => {
    try {
      setLoading(true);
      const data = await apiClient("/api/providers/notifications/list", {
        method: "GET",
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M12 6V3L8 7l4 4V8c2.8 0 5 2.2 5 5 0 1.6-.7 3.1-1.9 4.1L17 19.1C18.6 17.9 19.6 15.6 19.6 13c0-4.6-3.7-8.3-8.3-8.3S3 8.4 3 13h1.7C4.7 9.1 8 6 12 6z" />
              </svg>
            </button>
            <button
              ...
              >
                <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                  <Image
                    width={40}
                    height={40}
                    src={n.picture || "/images/main/small.svg"}
